...
/*--------------------------------------------------------------------------*/
/* EXTERNS */
// Pointer to the system scheduler
...
static void thread_shutdown() {
     ...
     */
		/*Terminate the current thread and delete resources */
...
*/
    ...
    /* Disable interrupts during a context switch*/
    Machine::disable_interrupts();	
    threads_low_switch_to(_thread);
    /* Enable interrupts after a context swicth */
    Machine::enable_interrupts();
