...
/* struct bpred_t *		 
bpred_create_tournament(unsigned int fetch_regs_PC,
			 unsigned int sel_size,			  
			 unsigned int global_regsize,			
			 unsigned int local_htb_size,
			 unsigned int local_hrsize,
...
md_addr_t tournament_bpred_lookup(struct bpred_t *T_selector_pred,	/* branch predictor instance */
