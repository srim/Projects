...
enum cache_policy {
  ...
  SRRIP_HP,   //######DRRIP Project changes start here
  SRRIP_FP,
  BRRIP,
  DRRIP      //#####DRRIP Project changes end here
};
...
//#####DRRIP Project code modification starts here
extern unsigned int RRPV_M_Value;
extern unsigned int PSEL_COUNTER_WIDTH;
//#####DRRIP Project code modification ends here
